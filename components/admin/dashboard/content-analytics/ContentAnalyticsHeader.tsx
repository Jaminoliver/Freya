...
export default function ContentAnalyticsHeader() {
  ...
  return (
    <div className="header-wrap">
      <div className="header-left">
        <h1 className="header-title">Content Analytics</h1>
        <p className="header-sub">Monitor content performance, uploads, and engagement</p>
      </div>
