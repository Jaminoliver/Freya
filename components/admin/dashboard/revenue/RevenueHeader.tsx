...
import { Calendar, ChevronDown, RefreshCw, Bell } from "lucide-react";
import ExportRevenueButton from "./ExportRevenueButton";
  ...
  return (
    <div className="header-wrap">
      <div className="header-left">
        <h1 className="header-title">Revenue Analytics</h1>
        <p className="header-sub">Track earnings, commissions, and financial trends</p>
      </div>
          ...
          {open && (
            <div className="range-dropdown">
              {ranges.map((r) => (
                <button
                  key={r}
                  className={`range-option ${r === range ? "active" : ""}`}
