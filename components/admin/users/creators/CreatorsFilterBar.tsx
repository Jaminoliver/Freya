...
const TABS = [
  ...
  { key: "approved", label: "Approved", count: 1241 },
  { key: "rejected", label: "Rejected", count: 20   },
];

export default function CreatorsFilterBar({ search, onSearch, tab, onTab }: Props) {
  return (
      ...
      <div className="tabs-row">
        {TABS.map((t) => {
          ...
          return (
            ...
            >
              {t.label}
              <span className={`tab-count ${active ? "count-active" : ""} ${isPending && !active ? "count-pending" : ""}`}>
