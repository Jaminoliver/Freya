...
function VideoControls({ videoRef, containerRef, isMuted, onToggleMute, onFirstPlay, isMobile, isPortrait, bottomOffset = 0, isPlaying: isPlayingProp = false, fullscreenTopLeft = false }: ControlsProps) {
  ...
  return (
    <>
      ...
      <button style={{ ...btnStyle, position: "absolute", bottom: (isMobile && isPortrait ? bottomOffset + 24 : bottomOffset) + 10, right: 8, zIndex: 15, pointerEvents: "auto" }} onClick={handleFullscreen} onTouchEnd={(e) => { e.preventDefault(); e.stopPropagation(); handleFullscreen(e); }} aria-label={isFakeFullscreen || isFullscreen ? "Exit fullscreen" : "Fullscreen"}>
