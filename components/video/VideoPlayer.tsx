  ...
  return (
    <>
      ...
      <div
        ...
        style={{
          position:      "absolute",
          bottom:        isFakeFullscreen ? 0 : (isMobile && isPortrait) ? (fullscreenTopLeft ? bottomOffset + 48 : bottomOffset + 24) : bottomOffset, left: 0, right: 0,
          zIndex:        10,
          opacity:       visible ? 1 : 0,
      ...
      <button style={{ ...btnStyle, position: "absolute", bottom: (isMobile && isPortrait ? bottomOffset + 24 : bottomOffset) + 10, right: 8, zIndex: 15 }} onClick={handleFullscreen} onTouchEnd={(e) => { e.preventDefault(); e.stopPropagation(); handleFullscreen(e); }} aria-label={isFakeFullscreen || isFullscreen ? "Exit fullscreen" : "Fullscreen"}>
