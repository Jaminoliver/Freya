    ...
    <>
      ...
      {isMobile && (
        <div
          ...
          style={{ position: "absolute", bottom: 200, left: 0, right: 0, height: "20px", display: "flex", alignItems: "flex-end", cursor: "pointer", WebkitTapHighlightColor: "transparent", touchAction: "none", zIndex: 12, boxSizing: "border-box", opacity: 1, pointerEvents: "auto" }}
        >
      ...
      <button style={{ ...btnStyle, position: "absolute", bottom: bottomOffset + 8, right: 4, zIndex: 15, pointerEvents: "auto", filter: "drop-shadow(0 1px 3px rgba(0,0,0,0.9))" }} onClick={handleFullscreen} onTouchEnd={(e) => { e.preventDefault(); e.stopPropagation(); handleFullscreen(e); }} aria-label={isFakeFullscreen || isFullscreen ? "Exit fullscreen" : "Fullscreen"}>
