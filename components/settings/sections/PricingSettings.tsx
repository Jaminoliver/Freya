  ...
  return (
    <div>
      <div style={{ display: "flex", alignItems: "center", gap: "8px", marginBottom: "24px" }}>
        ...
        <h2 style={{ fontSize: "18px", fontWeight: 700, color: "#F1F5F9", margin: 0, fontFamily: "'Inter', sans-serif" }}>Pricing</h2>
      </div>
      <div style={{ color: "#A3A3C2", fontSize: "14px", fontFamily: "'Inter', sans-serif" }}>Pricing settings coming soon.</div>
    </div>
  );
}