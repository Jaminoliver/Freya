...
export default function EarningsSettings({
  ...
  return (
    <div style={{ fontFamily: "'Inter', sans-serif" }}>
      <div style={{ display: "flex", gap: "8px", overflowX: "auto", scrollbarWidth: "none", padding: "12px 0 12px", marginBottom: "24px", position: "sticky", top: 0, zIndex: 10, backgroundColor: "var(--background)" }}>
        {TABS.map((tab) => (
          <button
            key={tab.key}
...
function HistoryTabContent() {
  ...
  return (
    <div>
      <div style={{ display: "flex", gap: "6px", overflowX: "auto", paddingBottom: "4px", marginBottom: "16px", scrollbarWidth: "none", position: "sticky", top: 0, zIndex: 10, backgroundColor: "var(--background)", paddingTop: "12px" }}>
        {filters.map((f) => (
          <button
