...
export function ConversationRow({ conversation, isActive, onSelect }: Props) {
    ...
    >
      ...
      <div style={{ flex: 1, minWidth: 0 }}>
        <div style={{ display: "flex", alignItems: "center", gap: "5px", marginBottom: "3px" }}>
          ...
          {participant.isVerified && (
            <Sparkles size={13} color="#8B5CF6" strokeWidth={1.8} />
          )}

          <span style={{ fontSize: "12px", color: "#4A4A6A", whiteSpace: "nowrap" }}>
            @{participant.username}
          </span>
        </div>

        <div style={{ display: "flex", alignItems: "center", gap: "4px" }}>
          {hasMedia && <ImageIcon size={12} color="#6B6B8A" strokeWidth={1.8} />}
          <span
            style={{
              fontSize:     "13px",
              color:        "#6B6B8A",
      ...
      <div style={{ display: "flex", flexDirection: "column", alignItems: "flex-end", gap: "6px", flexShrink: 0 }}>
        <span
          style={{
            fontSize:   "12px",
            color:      unreadCount > 0 ? "#8B5CF6" : "#4A4A6A",
