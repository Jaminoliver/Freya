...
export function PPVMessage({ message, conversation, isOwn, onUnlock }: Props) {
      ...
      <div style={{ backgroundColor: "#1E1E2E", borderRadius: "12px", overflow: "hidden", width: "300px" }}>
        ...
        {message.text && (
          <div style={{ padding: "10px 14px 6px" }}>
            <p style={{ margin: 0, fontSize: "13px", color: "#A3A3C2", lineHeight: 1.4 }}>
              {message.text}
            </p>
          </div>
        )}
        ...
        {isOwn && (
          <div style={{ padding: "6px 14px 10px" }}>
            <span
              style={{
                fontSize: "11px",
                color:    isUnlocked ? "#10B981" : "#4A4A6A",
              }}
            >
