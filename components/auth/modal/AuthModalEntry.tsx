...
export function AuthModalEntry({ onNavigate, onClose }: Props) {
    ...
    <>
      ...
      <div style={styles.modalBody}>
        ...
        <div style={styles.formStack}>
          <button style={styles.btnSecondary} onClick={() => onNavigate(1)}>
...
const styles: Record<string, React.CSSProperties> = {
  ...
  modalBody: {
    padding: "24px 24px 28px", display: "flex", flexDirection: "column", gap: "20px",
  },
  heading: {
