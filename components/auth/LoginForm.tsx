...
function LoginFormInner() {
  ...
  return (
    <div style={{ width: "390px", minHeight: "100vh", backgroundColor: "#0A0A0F", fontFamily: "'Inter', sans-serif", display: "flex", flexDirection: "column", position: "relative", overflowX: "hidden" }}>
      <div style={{ position: "sticky", top: 0, zIndex: 10, backgroundColor: "#0A0A0F", display: "flex", alignItems: "center", justifyContent: "space-between", padding: "16px 16px 12px 2px" }}>
        <img src="/freya_logo.png" alt="Fréya" style={{ height: "90px", width: "auto", marginLeft: "-10px" }} />
      ...
      <div style={{ padding: "8px 24px 0" }}>
        <h1 style={{ margin: "0 0 8px", fontSize: "18px", fontWeight: 600, background: "linear-gradient(90deg, #8B5CF6, #EC4899)", WebkitBackgroundClip: "text", WebkitTextFillColor: "transparent", backgroundClip: "text", lineHeight: 1.25 }}>
          Welcome Back.
        </h1>
        <p style={{ color: "#A3A3C2", fontSize: "13px", margin: 0, lineHeight: 1.5 }}>Log in to continue on Fréya.</p>
      </div>
      ...
      <div style={{ padding: "12px 24px 120px", display: "flex", flexDirection: "column", gap: "20px" }}>
        ...
        <form onSubmit={handleSubmit} noValidate style={{ display: "flex", flexDirection: "column", gap: "16px" }}>
          ...
          <button type="submit" disabled={loading} style={{ width: "100%", borderRadius: "10px", padding: "11px 24px", fontSize: "14px", fontWeight: 600, border: "none", cursor: loading ? "not-allowed" : "pointer", backgroundColor: loading ? "#6d44c4" : "#8B5CF6", color: "#FFFFFF", boxShadow: "0 4px 24px rgba(139,92,246,0.35)", marginTop: "4px" }}>
          ...
          <div style={{ display: "flex", alignItems: "center", justifyContent: "center", gap: "12px", fontSize: "13px" }}>
            ...
            <Link href="/signup" style={{ color: "#8B5CF6", textDecoration: "none", fontWeight: 500 }}>Sign up for Fréya</Link>
          </div>
